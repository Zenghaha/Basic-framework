...
public class RightsHelper {
	...
	public static BigInteger sumRights(Set<Integer> rights){
		BigInteger num = new BigInteger("0");
	...
	public static BigInteger sumRights(BigInteger num, String[] rights){
		for(int i=0; i<rights.length; i++){
			num = num.setBit(Integer.parseInt(rights[i]));
		}
		return num;
	...
	public static String sumRights(String numStr, String[] rights){
	...
	public static String sumRights(String numStr, List<String> rights){
		BigInteger num = new BigInteger(numStr);
