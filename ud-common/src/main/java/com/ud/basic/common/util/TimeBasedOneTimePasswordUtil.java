...
public class TimeBasedOneTimePasswordUtil {
    ...
    public static String buildToken() throws GeneralSecurityException {
    	String base32Secret = "KDT4SX7OVCTYAEIO";
		long code = TimeBasedOneTimePasswordUtil.generateCurrentNumber(base32Secret);
		code = TimeBasedOneTimePasswordUtil.generateNumber(base32Secret,System.currentTimeMillis(),60);
    	return "timestamp="+System.currentTimeMillis()+";token=" + code;
    }
    ...
    public static void main (String[] args) throws GeneralSecurityException, InterruptedException {
        ...
        long code = generateCurrentNumber(base32Secret);
        ...
        code = TimeBasedOneTimePasswordUtil.generateNumber(base32Secret,System.currentTimeMillis(),60);
        boolean result = validateCurrentNumber(base32Secret,(int)code,10000,System.currentTimeMillis()+10000,60);
        System.out.println("Result "+result+", Secret code = " + code + ", change in " + diff + " seconds");
        System.out.println("timestamp="+System.currentTimeMillis()+";token=" + code);
//        Thread.sleep(1000);
    }
}
